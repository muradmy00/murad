...
export const skills: Skill[] = [
    ...
    { id: '12', name: 'Quill', category: 'Tools', proficiency: 75 },
    ...
    { id: '17', name: 'Video.js', category: 'Tools', proficiency: 78 },
    { id: '18', name: 'YUP', category: 'Tools', proficiency: 82 },
    { id: '19', name: 'Axios', category: 'Tools', proficiency: 88 },
    { id: '20', name: 'Expo', category: 'Tools', proficiency: 85 },
    { id: '21', name: 'Expo Router', category: 'Tools', proficiency: 85 },
    { id: '22', name: 'Yarn', category: 'Tools', proficiency: 90 },
    { id: '23', name: 'C', category: 'Languages', proficiency: 80 },
    { id: '24', name: 'C++', category: 'Languages', proficiency: 80 },
    { id: '25', name: 'Java', category: 'Languages', proficiency: 75 },
    { id: '26', name: 'Python', category: 'Languages', proficiency: 70 },
];
