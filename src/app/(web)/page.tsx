  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      ...
      <section className="py-24 md:py-32 text-center">
        <h1 className="font-headline text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter mb-4">
      ...
      <section className="py-16 md:py-24 bg-card border rounded-xl">
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-12 px-6">
            <div className="flex justify-center md:justify-end">
                <div className="relative">
                    <Image
                        src="https://picsum.photos/seed/avatar-about/400/400"
                        alt="Mohiuddin Murad"
                        width={400}
                        height={400}
